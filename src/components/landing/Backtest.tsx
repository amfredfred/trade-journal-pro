      ...
      <div className="bfx-section-inner">
        <div style={{ textAlign: "center", marginBottom: 52 }}>
          ...
          <p className="bfx-sub" style={{ margin: "0 auto" }}>
            Walk-forward simulation. <strong>10 months</strong>, <strong>10 liquid pairs</strong>, <strong>1,484 trades</strong>.
            No cherry-picking — session filters match live trading discipline exactly.
          </p>
        </div>
        ...
        <div className="bfx-bt-grid">
          ...
          <div>
            ...
            <div className="bfx-bt-cta">
              ...
              <p className="bfx-bt-cta-desc">
                Download the complete trade-by-trade CSV with symbol, timeframe, session,
                entry, SL, TP, R:R, and outcome for all 1,484 trades. Includes the full
          ...
          <div>
            <div className="bfx-equity-wrap">
              ...
              <svg viewBox="0 0 480 220" width="100%" style={{ display: "block", overflow: "visible" }} aria-label="Equity curve showing +1,111.45R over 10 months">
                <defs>
                ...
                {[180, 140, 100, 60, 20].map(y => (
                  <line key={y} x1="0" y1={y} x2="480" y2={y} stroke="#24242f" strokeWidth={0.5} />
                ))}
                {["0R", "250R", "500R", "750R", "1000R"].map((t, i) => (
                  <text key={t} x="5" y={183 - i * 40} fill="#52526a" fontSize="9" fontFamily="JetBrains Mono,monospace">{t}</text>
                ))}
              ...
              <div className="bfx-eq-method">
                Walk-forward simulation · 10 liquid pairs incl. XAU/USD ·
                Session-filtered (Tokyo + London + NY) · Min 1.5 R:R · Max 2.5 R:R ·
                Breakeven management active · Pivot-based BOS detection · 30M/5M + 1H/5M
              </div>
            </div>
          </div>
        </div>
