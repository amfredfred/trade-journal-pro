      ...
      <div className="bfx-section-inner">
        <div style={{ textAlign: "center", marginBottom: 52 }}>
          ...
          <p className="bfx-sub" style={{ margin: "0 auto" }}>
            Seven years of data. <strong>6 instruments</strong>, <strong>25,403 trades</strong>.
        ...
        <div className="bfx-bt-grid">
          {/* ── LEFT ── */}
          <div>
            <div className="bfx-bt-run">RUN: 6 instruments · Jan 2019 → May 2026 · EURUSD · XAUUSD · US100 · US30 · US500 · JP225</div>
            <div className="bfx-bt-stats">
              {[
                { v: "+20,127R",  lbl: "Total return",      color: "var(--gold)"  },
                { v: "+0.79R",    lbl: "Return per trade",  color: "var(--green)" },
                { v: "2.37",      lbl: "Profit factor",     color: "var(--text)"  },
                { v: "−23.85R",   lbl: "Max drawdown",      color: "var(--red)"   },
                { v: "25,403",    lbl: "Total trades",      color: "var(--text)"  },
                { v: "7 years",   lbl: "Data scope",        color: "var(--text)"  },
              ].map(s => (
            ...
            <div className="bfx-bt-cta">
              <div className="bfx-bt-cta-title">Full results available inside the app</div>
              <p className="bfx-bt-cta-desc">
                Every trade is logged — symbol, direction, entry, exit, and result.
                Sign in to view the complete 7-year dataset across all 6 instruments.
              </p>
          ...
          <div>
            <div className="bfx-equity-wrap">
              <div className="bfx-eq-head">
                <div>
                  <div style={{ fontFamily: "var(--mono)", fontSize: 11, color: "var(--muted)", marginBottom: 6, letterSpacing: "0.05em" }}>
                    CUMULATIVE RETURN — 7 YEARS
                  </div>
                  <div className="bfx-eq-total">+20,127R</div>
                </div>
                <div>
              ...
              {/* SVG equity curve — derived from 7-year monthly data */}
              <svg viewBox="0 0 480 210" width="100%" style={{ display: "block", overflow: "visible" }} aria-label="Equity curve showing +20,127R over 7 years">
                <defs>
              ...
              <div className="bfx-eq-method">
                7-year simulation · 6 instruments including XAU/USD &amp; US indices ·
