  ...
  return (
    <header className="bfx-nav">
      ...
      <div className="bfx-nav-cta">
        <a href="https://bbfx.netlify.app/login" className="bfx-btn-ghost" style={{ fontSize: 14 }}>Log in</a>
        <a href="https://bbfx.netlify.app/login" className="bfx-btn-primary" style={{ padding: "10px 22px", fontSize: 14 }}>Get started →</a>
      </div>
      ...
      <AnimatePresence>
        {open && (
          <motion.div initial={{ opacity: 0, height: 0 }} animate={{ opacity: 1, height: "auto" }} exit={{ opacity: 0, height: 0 }} className="bfx-mobile-menu">
            ...
            <a href="https://bbfx.netlify.app/login" className="bfx-mobile-cta-btn">Get started →</a>
          </motion.div>
        )}
      </AnimatePresence>
    </header>
