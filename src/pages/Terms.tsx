  ...
  return (
    <div style={{ background: "#0a0a0a", minHeight: "100vh", fontFamily: "var(--sans)" }}>
      ...
      <div style={{ maxWidth: 760, margin: "0 auto", padding: "64px 40px 100px" }}>
        ...
        {/* Risk warning banner */}
        <Warning>
          <strong style={{ color: "#00d68f", display: "block", marginBottom: 6, fontFamily: "var(--display)", fontSize: 14 }}>⚠ Important Risk Disclosure</strong>
          Trading foreign exchange, CFDs, and other leveraged financial instruments involves a high degree of risk and may not be suitable for all investors. You may lose some or all of your invested capital. Past performance — including backtested results published on this website — does not guarantee future returns. The +20,126.55R backtest figure was generated through an 89-month simulation on historical data and is not a guarantee of live trading performance. Never trade with money you cannot afford to lose. Seek independent financial advice if necessary.
          ...
          <Section title="2. Description of Service">
            ...
            <Li><strong style={{ color: "#e0e0e0" }}>Live Signal Engine</strong> — Algorithmic detection of HTF supply and demand zones across 6 instruments; real-time entry signal generation with entry, SL, and TP levels</Li>
          ...
          <Section title="8. Disclaimers">
            ...
            <Sub title="8.2 Backtest results">
              <p>Historical backtest results, including the +20,126.55R figure, are simulated results based on historical market data. Simulated results have inherent limitations: they are computed with the benefit of hindsight, do not account for real broker slippage or spread variations, and cannot account for market impact. These results do not represent actual trading and should not be relied upon as a guarantee of future performance.</p>
            </Sub>
